...
public class KioskAuthorizationFilter extends BasicAuthenticationFilter{
	private StoreRepository storeRepository;
	
	private JwtToken jwtToken = new JwtToken();
	
	public KioskAuthorizationFilter(AuthenticationManager authenticationManager,StoreRepository storeRepository) {
	 ...
	 @Override
	    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
	        ...
	        System.out.println("KioskAuthorizationFilter 요청 URI: " + uri);
	        System.out.println("Authorization 헤더: " + request.getHeader("Authorization"));

	        if (uri.equals("/kiosk/login")) {
	        ...
	        String accessToken = accessTokenHeader.replace(JwtProperties.TOKEN_PREFIX, "").replace("\"", "")
	        	    .trim();
	        ...
	        try {
	            ...
	            PrincipalDetails principalDetails = new PrincipalDetails(store);
